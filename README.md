...
<sub>typescript · next.js · postgres · mcp</sub>

**[editskill](https://github.com/MatthewKim323/editskill)**<br>
agent prompts to demo videos\. capture a website, edit a recordly project, and render an mp4 in headless chromium\.<br>
<sub>python · node.js · chromium · recordly</sub>

**[1to1](https://github.com/MatthewKim323/1to1)**<br>
measure a live website, rebuild its layout and motion, then verify the result with pixel diffs across breakpoints\.<br>
<sub>typescript · bun · chromium</sub>

**[nerve](https://github.com/MatthewKim323/agarstra)**<br>
...
<picture>
  ...
  <img src="./assets/activity-light.svg" width="760" alt="3,119 contributions across 345 active days in the displayed period.">
</picture>
...
<sub>GitHub-reported activity · public repository language bytes · refreshed 2026-09-17</sub>
